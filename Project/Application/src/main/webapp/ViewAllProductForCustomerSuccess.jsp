<%@page import="com.chaitu.bean.CustomerBean"%>
...
<%
    ...
    out.println("Page belongs to Customer : " + cb.getUserName() + "<br>");
...
<div class="product-container">
    ...
    <div class="product-card">
        ...
        <a href="Buy?pcode=<%= pb.getProductID() %>">
            <button class="btn">Buy</button>
        </a>
        <a href="AddToCart?pcode=<%= pb.getProductID() %>">
